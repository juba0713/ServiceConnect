...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isCategoryWisePackageServiceAtom = Atom(name: '_AppStore.isCategoryWisePackageService', context: context);
  ...
  set isCategoryWisePackageService(bool value) {
    _$isCategoryWisePackageServiceAtom.reportWrite(value, super.isCategoryWisePackageService, () {
  ...
  late final _$notificationCountAtom = Atom(name: '_AppStore.notificationCount', context: context);
  ...
  late final _$completedBookingAtom = Atom(name: '_AppStore.completedBooking', context: context);
  ...
  late final _$totalHandymanAtom = Atom(name: '_AppStore.totalHandyman', context: context);
  ...
  late final _$selectedServiceListAtom = Atom(name: '_AppStore.selectedServiceList', context: context);
  ...
  late final _$selectedServiceDataAtom = Atom(name: '_AppStore.selectedServiceData', context: context);
  ...
  late final _$removeSelectedServiceAsyncAction = AsyncAction('_AppStore.removeSelectedService', context: context);

  @override
  Future<void> removeSelectedService(ServiceData val, {int selectedIndex = -1}) {
    return _$removeSelectedServiceAsyncAction.run(() => super.removeSelectedService(val, selectedIndex: selectedIndex));
  }
  ...
  late final _$addSelectedPackageServiceAsyncAction = AsyncAction('_AppStore.addSelectedPackageService', context: context);

  @override
  Future<void> addSelectedPackageService(ServiceData val) {
    return _$addSelectedPackageServiceAsyncAction.run(() => super.addSelectedPackageService(val));
  }

  late final _$addAllSelectedPackageServiceAsyncAction = AsyncAction('_AppStore.addAllSelectedPackageService', context: context);

  @override
  Future<void> addAllSelectedPackageService(List<ServiceData> val) {
    return _$addAllSelectedPackageServiceAsyncAction.run(() => super.addAllSelectedPackageService(val));
  }

  late final _$removeSelectedPackageServiceAsyncAction = AsyncAction('_AppStore.removeSelectedPackageService', context: context);

  @override
  Future<void> removeSelectedPackageService(ServiceData val) {
    return _$removeSelectedPackageServiceAsyncAction.run(() => super.removeSelectedPackageService(val));
  }

  late final _$setCategoryBasedPackageServiceAsyncAction = AsyncAction('_AppStore.setCategoryBasedPackageService', context: context);

  @override
  Future<void> setCategoryBasedPackageService(bool val) {
    return _$setCategoryBasedPackageServiceAsyncAction.run(() => super.setCategoryBasedPackageService(val));
  }
  ...
  late final _$setNotificationCountAsyncAction = AsyncAction('_AppStore.setNotificationCount', context: context);

  @override
  Future<void> setNotificationCount(num val) {
    return _$setNotificationCountAsyncAction.run(() => super.setNotificationCount(val));
  }
  ...
  Future<void> setPlanSubscribeStatus(bool val) {
    return _$setPlanSubscribeStatusAsyncAction.run(() => super.setPlanSubscribeStatus(val));
  }
  ...
  late final _$setCompletedBookingAsyncAction = AsyncAction('_AppStore.setCompletedBooking', context: context);

  @override
  Future<void> setCompletedBooking(int val) {
    return _$setCompletedBookingAsyncAction.run(() => super.setCompletedBooking(val));
  }
  ...
  Future<void> setServiceAddressId(int val) {
    return _$setServiceAddressIdAsyncAction.run(() => super.setServiceAddressId(val));
  }
  ...
  Future<void> setHandymanAvailability(int val) {
    return _$setHandymanAvailabilityAsyncAction.run(() => super.setHandymanAvailability(val));
  }
  ...
  void setTotalHandyman(int val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setTotalHandyman');
    try {
  ...
  void setSelectedServiceData(ServiceData data) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setSelectedServiceData');
    try {
