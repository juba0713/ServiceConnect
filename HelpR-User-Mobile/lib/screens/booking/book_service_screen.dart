...
class _BookServiceScreenState extends State<BookServiceScreen> {
  ...
  String bookingType = "Walk-in"; // Default selection
...
void onBookingTypeChanged(String? newValue) {
  setState(() {
    bookingType = newValue!;
  });
}

 Widget buildBookingTypeInput() {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text("Booking Type", style: boldTextStyle(size: LABEL_TEXT_SIZE)),
      8.height,
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.grey), // Adjust border color
        ),
        child: DropdownButton<String>(
          value: bookingType,
          items: <String>['Walk-in', 'In My Location'].map((String value) {
