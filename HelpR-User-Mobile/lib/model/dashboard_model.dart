...
class DashboardResponse {
  ...
  List<ServiceLocationResponse>? serviceLocations;
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    /*
serviceLocations: (json['categories'] as List<dynamic>?)
          ?.map((e) => RealCategoryData.fromJson(e))
          .toList(),
    */
    return DashboardResponse(

      serviceLocations: json['service_locations'] != null ? (json['service_locations'] as List).map((i) => ServiceLocationResponse.fromJson(i)).toList() : null,
      ...
      isEmailVerified: json['is_email_verified'] != null ? 1 : 0,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.serviceLocations != null){
      data['service_locations'] = this.serviceLocations!.map((v) => v.toJson()).toList();
    }
