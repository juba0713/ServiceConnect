...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$userWalletAmountAtom = Atom(name: '_AppStore.userWalletAmount', context: context);
  ...
  late final _$setUserWalletAmountAsyncAction = AsyncAction('_AppStore.setUserWalletAmount', context: context);

  @override
  Future<void> setUserWalletAmount() {
    return _$setUserWalletAmountAsyncAction.run(() => super.setUserWalletAmount());
  }
  ...
  Future<void> setUseMaterialYouTheme(bool val) {
    return _$setUseMaterialYouThemeAsyncAction.run(() => super.setUseMaterialYouTheme(val));
  }
  ...
  Future<void> setCurrentLocation(bool val) {
    return _$setCurrentLocationAsyncAction.run(() => super.setCurrentLocation(val));
  }
